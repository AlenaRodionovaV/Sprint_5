...
class TestMoveToAcc:
    ...
    def test_move_to_acc(self, driver):
        ...
        success_move_to_acc = WebDriverWait(driver, 5).until(
            expected_conditions.visibility_of_element_located(Locators.CHANGE_PERSONAL_DATA_TEXT))

        assert success_move_to_acc.text == 'В этом разделе вы можете изменить свои персональные данные'
